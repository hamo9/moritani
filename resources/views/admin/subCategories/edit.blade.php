    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header">
                <h5>تعديل القسم {{ $subCategory->getTranslation('name','ar') }}</h5>
            </div>
            <div class="card-body">
                ...
                {{-- CATEGORY NAME_AR --}}
                        <div class="col-md-6">
                            <div class="form-group mb-2 mt-0 pt-0">
                                ...
                                <input class="form-control" type="text" name="name_ar" id="" value="{{$subCategory->getTranslation('name','ar')}}">
                                @error('name_ar')
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2 mt-0 pt-0">
                                ...
                                <input class="form-control" type="text" name="name_fr" value="{{$subCategory->getTranslation('name','fr')}}">
                                @error('name_fr')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
